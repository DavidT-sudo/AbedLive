...
export default async function AdminHeroPage() {
  ...
  return (
    <>
      <h1>Hero</h1>
      <p className="admin-subtitle">The full-bleed section at the top of the homepage.</p>
      <div className="admin-card">
        <form className="admin-form" action={updateHero}>
          <div className="admin-form-row">
            <label>
              Title line 1
              <input name="titleLine1" defaultValue={hero?.titleLine1} required />
            </label>
            <label>
              Title line 2
              <input name="titleLine2" defaultValue={hero?.titleLine2} required />
            </label>
          </div>
          <label>
          ...
          <div className="admin-form-row">
            <label>
              Release CTA label
              <input name="releaseCtaLabel" defaultValue={hero?.releaseCtaLabel} />
            </label>
            <label>
              Release CTA link
              <input name="releaseCtaHref" defaultValue={hero?.releaseCtaHref} />
            </label>
          </div>
          <label>
            Background image
